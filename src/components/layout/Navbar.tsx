      ...
      >
        <header
          className={`max-w-[1200px] mx-auto rounded-full border transition-all duration-500 ${
            scrolled
              ? "bg-white/98 backdrop-blur-[20px] border-canvas-border shadow-[0_4px_24px_rgba(0,0,0,0.10)]"
              : "bg-white/95 backdrop-blur-[16px] border-canvas-border/80 shadow-[0_2px_16px_rgba(0,0,0,0.08)]"
          }`}
        >
