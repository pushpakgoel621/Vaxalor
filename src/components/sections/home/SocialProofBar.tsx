...
const COMPANY_LOGOS = [
  {
    ...
    logo: (
      <svg viewBox="0 0 120 28" className="h-6 w-auto">
        ...
        <text x="26" y="20" fontFamily="var(--font-heading)" fontWeight="600" fontSize="14" fill="currentColor">TechCorp</text>
      </svg>
    ),
  },
  {
    ...
    logo: (
      <svg viewBox="0 0 100 28" className="h-6 w-auto">
        ...
        <text x="30" y="20" fontFamily="var(--font-heading)" fontWeight="600" fontSize="14" fill="currentColor">BuildIt</text>
      </svg>
    ),
  },
  {
    name: "GrowthLab",
    logo: (
      <svg viewBox="0 0 130 28" className="h-6 w-auto">
        ...
        <text x="24" y="20" fontFamily="var(--font-heading)" fontWeight="600" fontSize="14" fill="currentColor">GrowthLab</text>
      </svg>
    ),
  },
  {
    ...
    logo: (
      <svg viewBox="0 0 110 28" className="h-6 w-auto">
        ...
        <text x="24" y="20" fontFamily="var(--font-heading)" fontWeight="600" fontSize="14" fill="currentColor">Nextera</text>
      </svg>
    ),
  },
  {
    name: "Streamline",
    logo: (
      <svg viewBox="0 0 140 28" className="h-6 w-auto">
        ...
        <text x="32" y="20" fontFamily="var(--font-heading)" fontWeight="600" fontSize="14" fill="currentColor">Streamline</text>
      </svg>
    ),
  },
  {
    ...
    logo: (
      <svg viewBox="0 0 110 28" className="h-6 w-auto">
        ...
        <text x="24" y="20" fontFamily="var(--font-heading)" fontWeight="600" fontSize="14" fill="currentColor">Vendora</text>
      </svg>
    ),
  },
  {
    ...
    logo: (
      <svg viewBox="0 0 120 28" className="h-6 w-auto">
        ...
        <text x="23" y="20" fontFamily="var(--font-heading)" fontWeight="600" fontSize="14" fill="currentColor">Catalyst</text>
      </svg>
    ),
  },
  {
    ...
    logo: (
      <svg viewBox="0 0 140 28" className="h-6 w-auto">
        ...
        <text x="28" y="20" fontFamily="var(--font-heading)" fontWeight="600" fontSize="14" fill="currentColor">StackPrime</text>
      </svg>
    ),
  },
];
      ...
      <div className="relative">
        ...
        <div className="animate-marquee flex items-center gap-16 md:gap-20 w-max group hover:[animation-play-state:paused]" style={{ animationDuration: "40s" }}>
          {logos.map((company, i) => (
            <div
              key={`${company.name}-${i}`}
              className="text-ink-400 hover:text-ink-200 transition-colors duration-300 opacity-60 hover:opacity-100 shrink-0"
              data-cursor="hover"
            >
              {company.logo}
            </div>
