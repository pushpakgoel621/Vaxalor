...
export function WhyChooseUs() {
  ...
  return (
    <section ref={sectionRef} className="bg-ink py-16 lg:py-[120px] lg:min-h-[80vh] overflow-hidden relative">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto md:px-6 lg:px-8">
        ...
        {/* USP Cards — horizontal swipe on mobile, scroll-reactive grid on desktop */}
        <div className="flex md:grid md:grid-cols-3 gap-4 md:gap-5 mt-10 md:mt-14 overflow-x-auto md:overflow-visible snap-x snap-mandatory scrollbar-hide px-6 md:px-0">
          {USP_DATA.map((usp, i) => {
            // On mobile, all cards are always "active" so they're equally readable;
            // scroll-cycling only makes sense on desktop where cards sit side-by-side.
            const isActive = isMobile ? true : i === activeUSP;
            return (
              <motion.div
                key={usp.title}
